...
// ************************************************************************************************
Points3DInspector::Points3DInspector(QWidget* parent)
	: QWidget(parent)
{
...
// ************************************************************************************************
void Points3DInspector::SetManager(IInspectorManager* manager)
{
	Manager = manager;

	connect(Manager, &IInspectorManager::PointSpawnedSignal, this, &Points3DInspector::PointSpawned);
	connect(Manager, &IInspectorManager::PointDestroyedSignal, this, &Points3DInspector::PointDestroyed);
	connect(Manager, &IInspectorManager::PointSelectedSignal, this, &Points3DInspector::PointSelected);
	connect(Manager, &IInspectorManager::PointModifiedSignal, this, &Points3DInspector::PointModified);
}
...
//		public slots
// ************************************************************************************************
void Points3DInspector::PointSpawned(const Point* point)
{
	// mesh
	...
	connect(picker, &Qt3DRender::QObjectPicker::clicked, helper.get(), &Points3DInspector::PickHelper::PickEvent);
...
// ************************************************************************************************
void Points3DInspector::PointDestroyed(const Point* point)
{
...
// ************************************************************************************************
void Points3DInspector::PointSelected(const Point* point)
{
	if (!point)
	{
		if (AnySelected)
...
// ************************************************************************************************
void Points3DInspector::PointModified(const Point* point)
{
