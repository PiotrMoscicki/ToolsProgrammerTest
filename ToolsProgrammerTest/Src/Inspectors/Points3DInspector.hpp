...
namespace TPT
{
	class Points3DInspector : public IInspector, public QWidget
	{
	public:
		Points3DInspector(QWidget* parent);
	...
	private:
		...
		{
		public:
			PickHelper(Points3DInspector* owner, size_t pointId) : Owner(owner), PointId(pointId) {}

			void PickEvent(Qt3DRender::QPickEvent* pick) { Owner->Manager->SelectPoint(PointId); }

		private:
			Points3DInspector * Owner;
			size_t PointId;
		};
